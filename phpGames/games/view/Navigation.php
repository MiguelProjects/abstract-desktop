...
class Navigation{
	public $state = "";
    //Despite the massive use of php its more or less just changing html things depending on the state of the model
	public function __construct($curr) {
        ...
        public function getNav(){
            $form = '<header><nav><ul>';
				if($this->state =="stats"){ 
                    //we can change what the form is based on what the state of the model is
